...
For my first inspiration, it came from Benho612 ([repository here](https://github.com/benho612/CMPM1212-D1-Assignement)). They added in sound design into their clicker game and although they went more above and beyond with their's including adding a volume slider and full songs into the game. I thought that the idea of a little sound in my game could do it some good and so I made a small sound that plays whenever the main button is pressed.

For my second inspiration, it came from Steppedcrown ([repository here](https://github.com/Steppedcrown/IncrementalGame)). They had a lot of stylistic changes that I could have pulled from in respect to the fact they had a lot of offer, however what I pulled and added into my game was simply the display of having a split screen with upgrades on one side and the main clicking button along with information on the other. I also incorporated a background image as well to really give a more gamelike feel that they also display in their own game.
